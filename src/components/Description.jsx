...
const Description = (props) => {
    ...
    const handleSingleSelectiondesc = (id) => {
      ...
      const fetchReviews = async (productId) => {
        try {
          const response = await fetch(`https://snbpnestbackend-i9aqei81v-murtazakhannns-projects.vercel.app/reviews/${productId}`);
      ...
      const handleReviewSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch(`https://snbpnestbackend-i9aqei81v-murtazakhannns-projects.vercel.app/product/${product._id}/addreview`, {
                method: 'POST',
                headers: {
