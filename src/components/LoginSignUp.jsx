...
const LoginSignUp = () => {
  ...
  const login = async () => {
    ...
    let responseData;
    await fetch("https://snbpnestbackend-i9aqei81v-murtazakhannns-projects.vercel.app/login" , {
      method: 'POST',
      headers: {
  ...
  const signup = async () => {
    ...
    let responseData;
    await fetch("https://snbpnestbackend-i9aqei81v-murtazakhannns-projects.vercel.app/signup" , {
      method: 'POST',
      headers: {
        Accept:'application/form-data' ,
        'Content-Type': 'application/json'
